...
export type PageType = 'dashboard' | 'completed' | 'analytics' | 'calendar' | 'notes' | 'graph-notes' | 'settings';
...
export const Sidebar: React.FC<SidebarProps> = ({ currentPage, onPageChange, isOpen, onToggle }) => {
  const menuItems: MenuItem[] = [
    ...
    { id: 'graph-notes', label: 'Graph Notes', icon: <FaCodeBranch size={20} />, description: 'Mapa de conhecimento visual' },
